        ...
        child: Column(
          children: [
            RoundedContainer(
              ...
              child: Stack(
                children: [
                  RoundedImage(imageUrl: Images.onboardingImage1, applyImageRadius: true,),
                  ...
                  Positioned(
                    ...
                    child: RoundedContainer(
                      radius: Sizes.sm,
                      backgroundColor: const Color.fromARGB(255, 0, 255, 13).withOpacity(0.8),
                      padding: const EdgeInsets.symmetric(horizontal: Sizes.sm, vertical: Sizes.xs),
                      child : Text('20%', style: Theme.of(context).textTheme.labelLarge!.apply(color: ConstColors.black),),
                    ),
                  ),
                ...
                children: [
                  ...
                  Row(
                    children: [
                      ...
                      const Icon(Iconsax.verify5, color: ConstColors.primary, size: Sizes.iconXs),
                    ],
                  ),
                  Row(
                    ...
                    children: [
                      ...
                      Container(
                        ...
                        child: SizedBox(
                          ...
                          child: Center(child: const Icon(Iconsax.add, color: ConstColors.white,)))
                      )
                    ],
                  )
                ],
